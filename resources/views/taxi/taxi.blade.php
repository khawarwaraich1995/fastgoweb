...
<ul class="pricing-list mb-5" id="cat-cards" style="align-items: center;justify-content: center;display: none;">
    ...
    <li class="cat-card" data-charges="{{ $value->charges ?? '' }}" data-chargeType="{{ $value->charges_type ?? '' }}">
        <a href="javascript:void(0)">
            <span class="title" style="text-decoration: underline;">{{ $value->name ?? '' }}</span>
            @php
            ...
            @endphp
            <span class="image"><img src="{{$image}}" style="height: 100px;"></span>
            <span class="price">{{ $value->charges ?? '' }} <span>
