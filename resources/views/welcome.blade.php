                        ...
                        <div class="food-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="food-item">
                                        <div class="food-thumb df">
                                            <a href="#"><img style="height: 45px;width: 56px" src="{{ asset('kato') }}/assets/images/food/02.png" alt="food"></a>
                                        </div>
                                        <div class="food-content text-center">
                                            <a href="#">Lunch</a>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="food-item">
                                        <div class="food-thumb df">
                                            <a href="#"><img style="height: 45px;width: 56px" src="{{ asset('kato') }}/assets/images/food/03.png" alt="food"></a>
                                        </div>
                                        <div class="food-content text-center">
                                            <a href="#">Dinner</a>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="food-item">
                                        <div class="food-thumb df">
                                            <a href="#"><img style="height: 45px;width: 56px" src="{{ asset('kato') }}/assets/images/food/04.png" alt="food"></a>
                                        </div>
                                        <div class="food-content text-center">
                                            <a href="#">Drink</a>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="food-item">
                                        <div class="food-thumb df">
                                            <a href="#"><img style="height: 45px;width: 56px" src="{{ asset('kato') }}/assets/images/food/05.png" alt="food"></a>
                                        </div>
                                        <div class="food-content text-center">
                                            <a href="#">Juice</a>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="food-item">
                                        <div class="food-thumb df">
                                            <a href="#"><img style="height: 45px;width: 56px" src="{{ asset('kato') }}/assets/images/food/06.png" alt="food"></a>
                                        </div>
                                        <div class="food-content text-center">
                                            <a href="#">Coffee</a>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="food-item">
                                        <div class="food-thumb df">
                                            <a href="#"><img style="height: 45px;width: 56px" src="{{ asset('kato') }}/assets/images/food/07.png" alt="food"></a>
                                        </div>
                                        <div class="food-content text-center">
                                            <a href="#">Tea</a>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="food-item">
                                        <div class="food-thumb df">
                                            <a href="#"><img style="height: 45px;width: 56px" src="{{ asset('kato') }}/assets/images/food/08.png" alt="food"></a>
                                        </div>
                                        <div class="food-content text-center">
                                            <a href="#">Beef Roast</a>
                                        </div>
