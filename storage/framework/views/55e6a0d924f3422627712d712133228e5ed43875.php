...
<hr>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('ride-settings')); ?>">
                    <i class="ni ni-settings text-black"></i> <?php echo e(__('Ride Settings ')); ?>

                </a>
            </li>
</ul>
<?php /**PATH D:\XAMP\htdocs\fastgoweb\resources\views/layouts/navbars/menus/admin.blade.php ENDPATH**/ ?>