<?php $__env->startSection('content'); ?>
        ...
        <div class="row">
            <div class="col-xl-0 col-md-12 col-sm-12 order-xl-1">
              ...
              <!-- <button class="btn btn-sm btn-icon btn-success" data-toggle="modal" data-target="#exampleModalMessage" type="button">
                ...
                <a href="<?php echo e(url('/ride/categories/create')); ?>">
              ...
              <div class="container table-responsive py-4">
                <table class="table table-flush" id="datatable-buttons">
                  ...
                  <?php
                    $i = $i + 1;
                    $edit_url = url('/ride/categories/edit/'.$value->id);
                    $delete_url = url('/ride/categories/destroy/'.$value->id);
                  ?>
                    <tr>
    ...
    <script defer type="text/javascript">
          $('.status-change').on('click', function(){
              ...
              $.ajax({
              type:'POST',
              url:'<?php echo e(url("/ride/categories/status")); ?>',
...
<?php echo $__env->make('layouts.app', ['title' => __('Categories')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\fastgo\resources\views/categories/categories_list.blade.php ENDPATH**/ ?>