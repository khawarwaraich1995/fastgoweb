...
<?php $__env->startSection('content'); ?>
        ...
        <div class="row">
            <div class="col-xl-0 col-md-12 col-sm-12 order-xl-1">
              ...
              <!-- <button class="btn btn-sm btn-icon btn-success" data-toggle="modal" data-target="#exampleModalMessage" type="button">
                ...
                <a href="<?php echo e(url('/works/create')); ?>">
                  <button class="btn btn-sm btn-icon btn-warning" type="button">
                     <span class="btn-inner--icon"><i class="ni ni-fat-add"></i></span>
                     <span class="btn-inner--text">Add New Step</span>
                  </button>
                </a>
              </div>
              ...
              <div class="container table-responsive py-4">
                <table class="table table-flush" id="datatable-buttons">
                  ...
                  <?php
                    $i = $i + 1;
                    $edit_url = url('/works/edit/'.$value->id);
                    $delete_url = url('/works/destroy/'.$value->id);
                  ?>
                    <tr>
    ...
    <script defer type="text/javascript">
          $('.status-change').on('click', function(){
              ...
              $.ajax({
              type:'POST',
              url:'<?php echo e(url("/works/status")); ?>',
...
<?php echo $__env->make('layouts.app', ['title' => __('Work Steps')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMP\htdocs\fastgoweb\resources\views/works/categories_list.blade.php ENDPATH**/ ?>