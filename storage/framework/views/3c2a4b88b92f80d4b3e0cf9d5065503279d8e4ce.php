            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form id="settings" method="post" action="<?php echo e(url('ridesettings/update/' . ($settings->id ?? ''))); ?>"
                                ...
                                <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            ?>
                                            <input value="1" <?php echo e($checked); ?> type="checkbox"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-alternative" name="default_payment_type">
                                            <option value="stripe"
                                                <?php echo e(isset($settings->default_payment_type) && $settings->default_payment_type == 'stripe' ? 'selected' : ''); ?>>
                                                Stripe
                                                Card Processing</option>
                                            <option value="cod"
                                                <?php echo e(isset($settings->default_payment_type) && $settings->default_payment_type == 'cod' ? 'selected' : ''); ?>>
                                                COD
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input step=".01" type="text" name="currency" id="currency"
                                            class="form-control form-control" value="<?php echo e($settings->currency ?? ''); ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input step=".01" type="text" name="secret_key" id="secret_key"
                                                class="form-control form-control"
                                                value="<?php echo e($settings->secret_key ?? ''); ?>">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input step=".01" type="text" name="stripe_currecny" id="stripe_currecny"
                                                class="form-control form-control"
                                                value="<?php echo e($settings->stripe_currecny ?? ''); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
