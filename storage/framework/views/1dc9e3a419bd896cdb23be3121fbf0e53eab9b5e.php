...
<div class="card-body">
    <h6 class="heading-small text-muted mb-4"><?php echo e(__('Restaurant information')); ?></h6>
     ...
     <?php if(config('app.isft')): ?>
         ...
         <div class="pl-lg-4">
             <h4><?php echo e($order->client->name); ?></h4>
     ...
     <?php endif; ?>
     <hr />
     <h4><?php echo e(__("TOTAL")); ?>: <?php echo money($order->delivery_price+$order->order_price, $currency,true); ?></h4>
     <hr />
 ...
 </div><?php /**PATH E:\xampp\htdocs\fastgo\resources\views/orders/partials/orderinfo.blade.php ENDPATH**/ ?>